...
export default {
  ...
  methods: {
    ...
    async getAllData() {
      const content = axios({
        method: 'get',
        url: 'https://claris-backend.artisandigital.tech/api/get/list/byDay/6',
        headers: {
          Authorization:
    ...
    handleEditOk(e) {
      ...
      axios
        .put(
          'https://claris-backend.artisandigital.tech/api/update/todo/6',
          { day: 6, todo: this.taskInput },
          {
            headers: {
              Authorization:
