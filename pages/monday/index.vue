...
export default {
  ...
  methods: {
    ...
    async getAllData() {
      const content = axios({
        method: 'get',
        url: 'https://claris-backend.artisandigital.tech/api/get/list/byDay/2',
        headers: {
          Authorization:
    ...
    handleEditOk(e) {
      ...
      axios
        .put(
          'https://claris-backend.artisandigital.tech/api/update/todo/2',
          { day: 2, todo: this.taskInput },
          {
            headers: {
              Authorization:
