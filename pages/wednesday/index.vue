...
export default {
  ...
  methods: {
    ...
    async getAllData() {
      const content = axios({
        method: 'get',
        url: 'https://claris-backend.artisandigital.tech/api/get/list/byDay/4',
        headers: {
          Authorization:
    ...
    handleEditOk(e) {
      ...
      axios
        .put(
          'https://claris-backend.artisandigital.tech/api/update/todo/4',
          { day: 4, todo: this.taskInput },
          {
            headers: {
              Authorization:
